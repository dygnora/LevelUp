    ...
    render() {
        return createElement('div', { 
            ...
            createElement('div', { 
                ...
                createElement('div', { 
                    className: 'mb-8',
                    style: 'display: inline-block; background-color: var(--color-black); color: var(--color-primary); padding: 12px 24px; border-radius: 30px; border: 2px solid var(--color-black);'
                }, [
